...
### End User
You want to understand what the UI offers and what you can do with it.
→ [End User Guide](end-user/index.md)

### Operator
You are deploying and running this UI in your organisation.
→ [Operator Guide](operator/index.md)

### Contributor
You want to extend or improve this codebase.
