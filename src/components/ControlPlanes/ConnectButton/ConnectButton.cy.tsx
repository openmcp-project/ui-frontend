...
describe('ConnectButton', () => {
  ...
  describe('telemetry', () => {
    ...
    it('tracks controlplane.connected with idp=system when connecting via system IdP', () => {
      ...
      cy.get('@trackSpy').should('have.been.calledWith', { category: 'controlplane', action: 'connected', idp: 'system' });
    });
    ...
    it('tracks controlplane.connected with idp=custom when connecting via custom IdP', () => {
      ...
      cy.get('@trackSpy').should('have.been.calledOnce');
      cy.get('@trackSpy').should('have.been.calledWith', { category: 'controlplane', action: 'connected', idp: 'custom' });
    });
