...
import { DeleteMCPResource, DeleteMCPType, PatchMCPResourceForDeletion, PatchMCPResourceForDeletionBody } from "../../lib/api/types/crate/deleteMCP.ts";
      ...
      <Card style={{ margin: "12px 12px 12px 0" }} key={`${name}--${namespace}`}>
        <div style={{ padding: "20px" }}>
          <FlexBox direction="Column">
            ...
            <FlexBox direction="Row" justifyContent="SpaceBetween" alignItems="Center" style={{ paddingTop: "20px" }}>
