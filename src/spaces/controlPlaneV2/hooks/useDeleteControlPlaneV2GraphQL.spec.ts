...
import { useDeleteControlPlaneV2GraphQL } from './useDeleteControlPlaneV2GraphQL.ts';
...
describe('useDeleteManagedControlPlaneV2GraphQL', () => {
  ...
  it('should perform a valid delete request with correct variables', async () => {
    ...
    // ACT
    const renderHookResult = renderHook(() => useDeleteControlPlaneV2GraphQL('test-project--ws-test', 'my-mcp'));
  ...
  it('should show toast with success message on successful deletion', async () => {
    ...
    // ACT
    const renderHookResult = renderHook(() => useDeleteControlPlaneV2GraphQL('test-namespace', 'test-mcp'));
    const { deleteManagedControlPlaneV2 } = renderHookResult.result.current;
