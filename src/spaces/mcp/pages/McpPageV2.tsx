...
import { BusyIndicator, FlexBox, ObjectPage, ObjectPageHeader, ObjectPageTitle } from '@ui5/webcomponents-react';
...
import { McpContextProvider } from '../../../lib/shared/McpContext.tsx';
import { useGetMcpV2Query } from '../../onboarding/services/GetMcpService/GetMcpServiceV2.ts';
import { useGetMcpV2Kubeconfig } from '../../onboarding/services/GetMcpService/GetMcpV2KubeconfigService.ts';
...
export default function McpPageV2() {
  ...
  const {
    ...
    access,
    phase,
    isLoading: isKubeconfigLoading,
    error: kubeconfigError,
  } = useGetMcpV2Kubeconfig(controlPlaneName, `${projectName}-ws-${workspaceName}`);
    ...
    >
      <>
        ...
        >
          ...
          <ObjectPageSubSection id="configmaps" titleText={t('McpPage.configMapsTitle')} className={styles.section}>
            <McpConfigMaps />
          </ObjectPageSubSection>
